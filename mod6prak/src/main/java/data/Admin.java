...
public class Admin extends User implements iMenu {
    ...
    public void menu() {
        ...
        Button listBookButton       = new Button("Daftar Buku");
        ...
        grid.add(sceneTitle, 0, 0, 2, 1); // Title at row 0, span 2 columns
        grid.add(addStudentButton, 0, 1); // Buttons start at row 1
